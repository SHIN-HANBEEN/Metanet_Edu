...
<body>
    <div class="container mt-5">
            ...
            <tbody>
                <c:forEach var="employee" items="${empList}">
                    <tr>
                        ...
                        <td>
                            <a href="emp.do?action=update&empno=${employee.EMPNO}" class="btn btn-warning btn-sm">Update</a>
        ...
        <p><a href="emp.do?action=create" class="btn btn-primary">Create New Employee</a></p>
    </div>
