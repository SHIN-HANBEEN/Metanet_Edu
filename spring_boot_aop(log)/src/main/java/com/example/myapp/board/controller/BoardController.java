...
//		// 파라미터 username과 password가 데이터베이스의 정보와 같으면 
//		if(username.equals("db userid") && password.equals("db password")) {
//			session.setAttribute("userid", username);
//			return "redirect:/";
//		}else {
//			session.invalidate(); // 현재 세션을 무효화 함
...
//		session.invalidate();
//		return "member/login"; //로그인 페이지를 응답
//	}
...
//			return "member/login"; //login 폼 페이지
//		}else {
...
//	}
	...
	public String writeArticle(Board board, BindingResult results, String csrfToken, 
